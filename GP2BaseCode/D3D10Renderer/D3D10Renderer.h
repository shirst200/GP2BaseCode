...
//D3D10Renderer implements the render interface
class D3D10Renderer:public IRenderer
{
public:
	D3D10Renderer();
	~D3D10Renderer();
	//notice these have the same signiture as the pure methods in the interface
...
private:
	...
	bool createInitalRenderTarget(int windowWidth, int windowHeight);
private:
	//D3D10 stuff
